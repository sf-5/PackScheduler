...
public class StudentDirectoryTest {
	...
	public void testLoadStudentsFromFile() {
		...
		assertEquals(10, sd.getStudentDirectory().length);
		// Test invalid file
		assertThrows(IllegalArgumentException.class, () -> sd.loadStudentsFromFile("does-not-exist.txt"));
	}
	...
	public void testAddStudent() {
		...
		Exception e = assertThrows(IllegalArgumentException.class, () -> sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, "", PASSWORD, MAX_CREDITS));
	...
	public void testGetStudentById() {
		...
		assertEquals(sd.getStudentDirectory()[0][2], sd.getStudentById("daustin").getId());
