...
public class StudentDirectory {
	 ...
	 */
	public void loadStudentsFromFile(String fileName) throws IllegalArgumentException{
		try {
	 ...
	 * @throws IllegalArgumentException thrown if the password is invalid or if the passwords do not match
	 */
	public boolean addStudent(String firstName, String lastName, String id, String email, String password, String repeatPassword, int maxCredits) throws IllegalArgumentException{
		String hashPW = "";
		String repeatHashPW = "";
	...
	/**
	 * Hashes a String according to the SHA-256 algorithm, and outputs the 
	 * digest in base64 encoding.This allows the encoded digest to be safely 
	 * copied, as it only uses [a-zA-Z0-9+/=].
	 * 
	...
	/**
	 * Method used to get a student by their ID
	 * @param id id of the Student to be gotten
	 * @return the student if their ID matches
	 */
	 ...
	 */
	public void saveStudentDirectory(String fileName) throws IllegalArgumentException{
		try {
